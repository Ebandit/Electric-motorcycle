...
unsigned char indPixL = 17;  // defines left indicators first led on string
unsigned char indPixR = 6;  // defines right indicators first led on string
unsigned char indPixL1 = 61;  // defines left indicators first led on string
unsigned char indPixR1 = 50;  // defines right indicators first led on string
